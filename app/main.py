...
class UserSettings(BaseModel):
    ...
    add_a_min: int = Field(0)
    add_a_max: int = Field(20)
    add_b_min: int = Field(0)
    add_b_max: int = Field(20)
    sub_count: int = Field(10)
    sub_a_min: int = Field(0)
    sub_a_max: int = Field(20)
    sub_b_min: int = Field(0)
    sub_b_max: int = Field(20)
    mul_count: int = Field(0)
    mul_a_min: int = Field(1)
    mul_a_max: int = Field(9)
    mul_b_min: int = Field(1)
    mul_b_max: int = Field(9)
    div_count: int = Field(0)
    div_a_min: int = Field(1)
    div_a_max: int = Field(81)
    div_b_min: int = Field(2)
    div_b_max: int = Field(9)
